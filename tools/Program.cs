...
@"
#ifndef CPPVK_EXPORTED_FUNCTION
#    define CPPVK_EXPORTED_FUNCTION(name)
#endif

#ifndef CPPVK_EXT_INSTANCE_FUNCTION
#    define CPPVK_EXT_INSTANCE_FUNCTION(name)
#endif

#ifndef CPPVK_EXT_DEVICE_FUNCTION
#    define CPPVK_EXT_DEVICE_FUNCTION(name)
#endif

";
        private const string Safix =
@"
#ifdef CPPVK_EXPORTED_FUNCTION
#undef CPPVK_EXPORTED_FUNCTION
#endif

#ifdef CPPVK_EXT_INSTANCE_FUNCTION
#undef CPPVK_EXT_INSTANCE_FUNCTION
#endif

#ifdef CPPVK_EXT_DEVICE_FUNCTION
#undef CPPVK_EXT_DEVICE_FUNCTION
#endif
";
            ...
            try {
                ...
                foreach(KeyValuePair<string, Function> keyvalue in functions) {
                    ...
                    case Function.Type_Instance:
                        print("CPPVK_EXT_INSTANCE_FUNCTION(");
                        break;
                    case Function.Type_Device:
                        print("CPPVK_EXT_DEVICE_FUNCTION(");
                        break;
                    default:
                        print("CPPVK_EXPORTED_FUNCTION(");
                        break;
                    }
