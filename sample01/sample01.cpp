...
int main(int /*argc*/, char** /*argv*/)
{
    ...
    lgfx::Factory factory = lgfx::Factory::create();
    lgfx::Adapter adapter = lgfx::Adapter::create(factory, lgfx::FeatureLevel_11_0);
    lgfx::Device device = lgfx::Device::create(adapter, lgfx::FeatureLevel_11_0);
    lgfx::CommandQueue commandQueue = lgfx::CommandQueue::create(device, lgfx::CommandListType_Direct);
    lgfx::SwapChain swapchain = lgfx::SwapChain::create(factory, commandQueue, window.getHandle(), backCount, width, height, lgfx::Format_R8G8B8A8_UNORM, lgfx::Usage_RenderTargetOutput, lgfx::SwapEffect_FlipDiscard, 0, lgfx::MWA_NO_ALT_ENTER);
    lgfx::DescriptorHeap descriptorHeap = lgfx::DescriptorHeap::create(device, lgfx::HeapType_RTV, backCount, lgfx::HeapFlag_NONE);

    lgfx::Resource backBuffers[backCount];
    if(!lgfx::Resource::createBackBuffers(backCount, backBuffers, device, swapchain, descriptorHeap)){
        return EXIT_FAILURE;
    }

    lgfx::CommandAllocator commandAllocator = lgfx::CommandAllocator::create(device, lgfx::CommandListType_Direct);
    ...
    lgfx::RootSignature rootSignature = lgfx::RootSignature::create(device, rootSignatureDesc);
